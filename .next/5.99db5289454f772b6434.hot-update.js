...
function (_React$Component) {
  ...
  _createClass(DressCounter, [{
    ...
    value: function componentWillMount() {
      ...
      console.log(this.sale(this.props.id));
      this.sale(this.props.id) == 1 ? this.setState({
        saleText: 'Sale Dress'
      }) : this.setState({
        text: 'Sale Dresses'
      });
      this.setState({
        saleDresses: this.sale(this.props.id)
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=5.99db5289454f772b6434.hot-update.js.map