...
function (_React$Component) {
  ...
  _createClass(DressCounter, [{
    ...
    value: function componentWillMount() {
      ...
      console.log(__WEBPACK_IMPORTED_MODULE_1__static_data_data_navigation___default.a[this.props.id].dresses.sale[this.props.id]); // let saleDressCount = Data[this.props.id].dresses.sale == true.length;
...
//# sourceMappingURL=8.0b9d516a5433373cc8f6.hot-update.js.map