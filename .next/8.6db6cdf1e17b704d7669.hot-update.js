...
function (_React$Component) {
  ...
  _createClass(DressCounter, [{
    ...
    value: function componentWillMount() {
      ...
      var saleDressCount = __WEBPACK_IMPORTED_MODULE_1__static_data_data_navigation___default.a[this.props.id].dresses.sale == true.length;
      this.sale == 1 ? this.setState({
        saleText: 'Sale Dress'
      }) : this.setState({
        text: 'Sale Dresses'
      });
      this.setState({
        saleDresses: saleDressCount
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=8.6db6cdf1e17b704d7669.hot-update.js.map