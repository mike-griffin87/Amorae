...
function (_React$Component) {
  ...
  _createClass(DressCounter, [{
    ...
    value: function componentWillMount() {
      ...
      console.log(__WEBPACK_IMPORTED_MODULE_1__static_data_data_navigation___default.a[this.props.id].dresses.sale === true); // let saleDressCount = Data[this.props.id].dresses.sale == true.length;
...
//# sourceMappingURL=8.58389d7f1758c2dfb4a1.hot-update.js.map